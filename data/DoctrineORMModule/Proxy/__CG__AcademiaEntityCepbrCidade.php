...
class CepbrCidade extends \Academia\Entity\CepbrCidade implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\CepbrCidade' . "\0" . 'idCidade', '' . "\0" . 'Academia\\Entity\\CepbrCidade' . "\0" . 'cidade', '' . "\0" . 'Academia\\Entity\\CepbrCidade' . "\0" . 'codIbge', '' . "\0" . 'Academia\\Entity\\CepbrCidade' . "\0" . 'uf');
        }
