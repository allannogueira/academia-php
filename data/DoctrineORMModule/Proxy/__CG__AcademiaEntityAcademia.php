...
class Academia extends \Academia\Entity\Academia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\Academia' . "\0" . 'idAcademia', '' . "\0" . 'Academia\\Entity\\Academia' . "\0" . 'nome', '' . "\0" . 'Academia\\Entity\\Academia' . "\0" . 'dataCadastro', '' . "\0" . 'Academia\\Entity\\Academia' . "\0" . 'telefoneComercial1', '' . "\0" . 'Academia\\Entity\\Academia' . "\0" . 'telefoneComercial2', '' . "\0" . 'Academia\\Entity\\Academia' . "\0" . 'idMatriz', '' . "\0" . 'Academia\\Entity\\Academia' . "\0" . 'idEndereco');
        }
