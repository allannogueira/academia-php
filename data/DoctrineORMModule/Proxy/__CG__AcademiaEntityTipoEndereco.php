 ...
 */
class TipoEndereco extends \Academia\Entity\TipoEndereco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\TipoEndereco' . "\0" . 'id', '' . "\0" . 'Academia\\Entity\\TipoEndereco' . "\0" . 'descricao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoEndereco $proxy) {
