 ...
 */
class CepbrEndereco extends \Academia\Entity\CepbrEndereco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\CepbrEndereco' . "\0" . 'cep', '' . "\0" . 'Academia\\Entity\\CepbrEndereco' . "\0" . 'endereco', '' . "\0" . 'Academia\\Entity\\CepbrEndereco' . "\0" . 'idBairro', '' . "\0" . 'Academia\\Entity\\CepbrEndereco' . "\0" . 'idCidade');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CepbrEndereco $proxy) {
    ...
    public function getIdBairro()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdBairro', array());

        return parent::getIdBairro();
    }
