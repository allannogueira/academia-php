 ...
 */
class CepbrBairro extends \Academia\Entity\CepbrBairro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\CepbrBairro' . "\0" . 'idBairro', '' . "\0" . 'Academia\\Entity\\CepbrBairro' . "\0" . 'bairro', '' . "\0" . 'Academia\\Entity\\CepbrBairro' . "\0" . 'idCidade');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CepbrBairro $proxy) {
