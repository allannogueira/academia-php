 ...
 */
class Periodo extends \Academia\Entity\Periodo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\Periodo' . "\0" . 'idPeriodo', '' . "\0" . 'Academia\\Entity\\Periodo' . "\0" . 'periodo');
        }
