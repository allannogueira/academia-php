...
class Alimento extends \Academia\Entity\Alimento implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\Alimento' . "\0" . 'idAlimento', '' . "\0" . 'Academia\\Entity\\Alimento' . "\0" . 'nomeAlimento', '' . "\0" . 'Academia\\Entity\\Alimento' . "\0" . 'descricao', '' . "\0" . 'Academia\\Entity\\Alimento' . "\0" . 'idAcademia');
        }
