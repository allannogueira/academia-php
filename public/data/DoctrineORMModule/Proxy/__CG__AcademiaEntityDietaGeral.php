...
class DietaGeral extends \Academia\Entity\DietaGeral implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\DietaGeral' . "\0" . 'idDietaGeral', '' . "\0" . 'Academia\\Entity\\DietaGeral' . "\0" . 'nomeDieta', '' . "\0" . 'Academia\\Entity\\DietaGeral' . "\0" . 'idAcademia', '' . "\0" . 'Academia\\Entity\\DietaGeral' . "\0" . 'idFinalidade');
        }
