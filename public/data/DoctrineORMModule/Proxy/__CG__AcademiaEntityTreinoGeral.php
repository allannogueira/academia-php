...
class TreinoGeral extends \Academia\Entity\TreinoGeral implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\TreinoGeral' . "\0" . 'idTreinoGeral', '' . "\0" . 'Academia\\Entity\\TreinoGeral' . "\0" . 'nomeTreino', '' . "\0" . 'Academia\\Entity\\TreinoGeral' . "\0" . 'idAcademia', '' . "\0" . 'Academia\\Entity\\TreinoGeral' . "\0" . 'idFinalidade');
        }
