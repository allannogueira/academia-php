 ...
 */
class CepbrCidade extends \Academia\Entity\CepbrCidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Academia\\Entity\\CepbrCidade' . "\0" . 'idCidade', '' . "\0" . 'Academia\\Entity\\CepbrCidade' . "\0" . 'cidade', '' . "\0" . 'Academia\\Entity\\CepbrCidade' . "\0" . 'codIbge', '' . "\0" . 'Academia\\Entity\\CepbrCidade' . "\0" . 'area', '' . "\0" . 'Academia\\Entity\\CepbrCidade' . "\0" . 'uf');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CepbrCidade $proxy) {
    ...
    public function setCodIbge($codIbge)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCodIbge', array($codIbge));

        return parent::setCodIbge($codIbge);
    }
    ...
    public function getCodIbge()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCodIbge', array());

        return parent::getCodIbge();
    }
