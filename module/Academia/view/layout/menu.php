    ...
    <li class="active"><a href="<?php echo $this->url('home') ?>"><?php echo $this->translate('Home') ?></a></li>
        <li role="presentation" class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo $this->url('aluno') ?>"><?php echo $this->translate('Aluno') ?></a></li>
                        <li><a href="<?php echo $this->url('profissional') ?>"><?php echo $this->translate('Profissional') ?></a></li>
                        <li><a href="<?php echo $this->url('academia') ?>"><?php echo $this->translate('Academia') ?></a></li>
                        ...
                        <li><a href="<?php echo $this->url('exercicio') ?>"><?php echo $this->translate('Exercicio') ?></a></li>
                        <li><a href="<?php echo $this->url('treinoExercicio') ?>"><?php echo $this->translate('Treino x Exercicio') ?></a></li>
                        ...
                        <li><a href="<?php echo $this->url('frequencia') ?>"><?php echo $this->translate('Frequência Alunos') ?></a></li>
                        <li><a href="<?php echo $this->url('aparelho') ?>"><?php echo $this->translate('Aparelhos') ?></a></li>
                </ul>
        </li>
          <li role="presentation" class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo $this->url('aluno',array('action' => 'listar')) ?>"><?php echo $this->translate('Aluno') ?></a></li>
                        <li><a href="<?php echo $this->url('profissional',array('action' => 'listar')) ?>"><?php echo $this->translate('Profissional') ?></a></li>
                        <li><a href="<?php echo $this->url('academia',array('action' => 'listar')) ?>"><?php echo $this->translate('Academia') ?></a></li>
                        ...
                        <li><a href="<?php echo $this->url('exercicio',array('action' => 'listar')) ?>"><?php echo $this->translate('Exercicio') ?></a></li>
                        <li><a href="<?php echo $this->url('treinoExercicio',array('action' => 'listar')) ?>"><?php echo $this->translate('Treino x Exercicio') ?></a></li>
                        ...
                        <li><a href="<?php echo $this->url('aparelho',array('action' => 'listar')) ?>"><?php echo $this->translate('Aparelhos') ?></a></li>
                </ul>
        </li>
         <li role="presentation" class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo $this->url('bugReport',array('action' => 'listar')) ?>"><?php echo $this->translate('Bugs') ?></a></li>
