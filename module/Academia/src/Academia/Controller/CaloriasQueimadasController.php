...
class CaloriasQueimadasController extends AbstractController
{
    public function __construct()
    {
        $this->form = 'CaloriasQueimadasForm';
        $this->controller = 'CaloriasQueimadasController';
        $this->route = 'caloriasQueimadas';
        $this->service = 'Academia\Service\CaloriasQueimadasService';
        $this->entity = 'Academia\Entity\CaloriasQueimadas';
    }
